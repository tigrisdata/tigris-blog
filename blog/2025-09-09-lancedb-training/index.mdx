...
that the data is always ready to train on. Combine that with zero egress fees
and automatic global performance and you get hot replicas colocated with your
training jobs and zero egress fees between them.
