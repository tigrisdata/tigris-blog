...
import heroimage from "./drag-on-dragoon.jpg";
...
<img
  ...
  alt="A cartoon tiger in flashy plate armor wielding a draconic polearm while running down hills near Castro street in San Francisco."
/>

<center>
  <small>
    <em>
      A cartoon tiger in flashy plate armor wielding a draconic polearm while
      running down hills near Castro street in San Francisco.
    </em>
  </small>
</center>
...
vectors, all with features like versioning and fast random access. LanceDB can
also store raw bytes as columns, so you don’t need to manage your data
separately from your database.
