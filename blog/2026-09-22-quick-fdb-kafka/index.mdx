...
- You end up creating a lot of write pressure on your FoundationDB cluster. This
  ends up being a problem when the storage server is not able to keep up with
  the logs. Again, I'll expand on this some more later in the post.
