...
import Check from "@site/src/icons/check";
import Cross from "@site/src/icons/cross";
...
<table>
    ...
    <td>
      ...
      <ul>
        ...
        <li>
          ...
          for cross-shard transactions, read/write concern
        </li>
      </ul>
    </td>
  </tr>
  ...
  <tr vAlign="top">
    ...
    <td>
      ...
      <a href="https://www.tigrisdata.com/docs/concepts/architecture/">
