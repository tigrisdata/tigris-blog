---
slug: dev-containers-python
title: "Standardizing Python Environments with Development Containers"
description: >
  Conqueror the complexity of Python environments effortlessly. Discover how
  Development Containers offer a consistent, reliable setup for any Python
  project, eliminating dependency frustrations and boosting developer
  productivity.
image: ./shipyard.webp
keywords:
  [
...
authors: [xe]
tags: [python, development, containers, docker]
---
...
Hi, I’m Xe, and I’m a recovering former site reliability expert.
[Go](https://go.dev) is my main programming language of choice. I’d use it more,
but I’ve found myself working adjacent to the AI industry and this means that I
need to use Python more than I did in the past.

This shouldn't be that big of a deal, my first programming language was Python,
but there’s one small problem that has resulted in me thinking that I have been
cursed by an elder deity: Python environment management tools randomly break for
me. I’ve never been able to figure out why this happens, but in the last three
years I have not been able to consistently have basic editing, testing, or other
project management tooling work reliably. I’ve spent hours debugging weird
SIGBUS errors that nobody else can recreate and other things that go way above
and beyond normal debugging of issues.
...
Making things worse, there’s as many ways to manage Python dependencies as there
are grains of sand on the planet.

<center style={{ padding: "1.5rem" }}>
  [![](./xkcd_standards.webp)](https://xkcd.com/927/)
  <small>[Standards -- XKCD](https://xkcd.com/927/)</small>
</center>
