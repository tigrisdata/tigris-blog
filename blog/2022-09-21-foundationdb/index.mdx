...
the user's actual pain points like the "database sprawl" problems we covered in
our previous blog post:
["Why do companies need so many different database technologies"](../2022-06-27-sprawl/index.mdx).
