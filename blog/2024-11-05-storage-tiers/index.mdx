...
import heroImage from "./archive-tigers.webp";
...
![The Tigris Dashboard showing storage tier selection with three options: Standard, Infrequent Access, and Archive](./storage-tier.webp)
