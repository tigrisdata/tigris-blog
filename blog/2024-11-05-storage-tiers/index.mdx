...
description: >
  Tigris now supports storage tiers! Optimize your storage cost based on 
  access patterns with three tiers: Standard, Infrequent Access, and Archive.

image: ./archive-tigers.png
keywords:
  [object storage, blob storage, s3, ai, glacier, archive, cost savings]
authors: [ks]
...
<InlineCta title={"Want to try it out?"} subtitle={"Make a global bucket with no egress fees"} button={"Get Started"} />
