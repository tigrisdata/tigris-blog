...
keywords: [tigris database, tigris search, nextjs, trpc]
image: /static/tigris-database-search-trpc-nextjs/tigris-trpc-next-js.png
authors: [leggetter]
---
...
Next, define a `Post` model in a new file, `src/db/models/user.ts`:
