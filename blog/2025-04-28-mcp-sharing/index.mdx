...
image: ./ai-project-at-golden-gate.webp
keywords:
  - ai
  - vibe coding
  - language models
...
import ToolCallFlow from "./diagrams/ToolCallFlow";
...
import heroImage from "./ai-project-at-golden-gate.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="A blue Tiger works with a coworker at a laptop in front of the Golden Gate Bridge."
/>
