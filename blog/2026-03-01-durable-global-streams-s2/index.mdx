...
[found problems](https://jepsen.io/analyses/nats-jetstream-2.9.0) with this). Redis Streams is
...
sequence of monotonically increasing objects. Object storage is already the cheapest
