...
import heroImage from "./tiger-ship.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="A majestic blue tiger riding on a sailing ship. The tiger is very large."
/>
...
<InlineCta
  title={"Ready to store your chonky models?"}
  subtitle={
    "Upload models up to 5TB with no egress fees. Global distribution built in."
  }
  button={"Get started"}
/>
