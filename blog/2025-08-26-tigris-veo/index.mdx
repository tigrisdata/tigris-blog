...
Clone the [GitHub repository](https://github.com/tigrisdata/examples.git) and
move to the `veo/typescript` directory to follow the instructions.

```bash
git clone https://github.com/tigrisdata/examples.git
cd examples/veo/typescript
```
