...
import heroPoster from "./ty-scientist.webp";
...
>
  Cinematic. An Extreme Close-Up of a scientist's trembling hands holding a test
...
<video controls width="100%">
  ...
  />
  Download the{" "}
  <a href="/blog/img/blog/veo3-tigris/ai-studio-get-api-key">MP4</a> version.
</video>
...
<video controls width="100%">
  ...
  />
  Download the{" "}
  <a href="/blog/img/blog/veo3-tigris/tigris_create_access_keys.mp4">MP4</a>{" "}
  version.
</video>
...
<video controls width="100%">
  <source
    ...
    type="video/mp4"
  />
  Download the <a href="/blog/img/blog/veo3-tigris/enhance-prompt">MP4</a>{" "}
  version.
</video>
