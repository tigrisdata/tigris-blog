---
slug: nomadic-compute
title: Nomadic Infrastructure Design for AI Workloads
description: >
  This AI stuff is cool, but GPU inference is not needed all of the time. Most
  of the time your instances stay idle, which means you're just burning investor
  money without any real benefit. Today we'll learn how to make your compute
  spread between hosts nomadically, hunting deals and using Tigris to make it
  all possible.
image: ./nomadic-compute.webp
keywords:
  - object storage
  - blob storage
  - s3
...
import heroImage from "./nomadic-compute.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="A nomadic server hunting down wild GPUs in order to save money on its cloud computing bill. Image generated with Flux [dev] from Black Forest Labs on fal.ai"
/>
...
“workload”, you should think about some program that has network access to some
network and some amount of storage through some means running somewhere,
...
<PullQuote>Tigris is object storage with zero egress fees.</PullQuote>
...
![A graph showing Bluesky user activity](./bluesky-activity-graph.jpg)

<center>
  <small>
    A graph showing [Bluesky](https://bsky.social/about) user activity. Note how
    there's a sinusodal pattern and user operations have a daily peak before
    falling down to zero as everyone goes to sleep. This kind of sinusodal
    pattern is something you see all over the industry and is generally a sign
    of a healthy service. Imagine scaling things down as the graph trends
    downwards and then back up as the graph trends upwards.
  </small>
</center>
...
<PullQuote>
  How will your storage plane adapt to your needs instead of your needs adapting
  to your storage plane?
</PullQuote>
...
![A diagram showing the big queue.](./model-storage-diagram.webp)
