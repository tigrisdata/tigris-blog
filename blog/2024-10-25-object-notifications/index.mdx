...
Tigris now supports object notifications! Object notifications are a way of
receiving events for changes in a bucket. Think of it as your bucket's way of
saying, "Hey, something happened! Come check it out!" These notifications can be
helpful for keeping track of what's going on in your application.
