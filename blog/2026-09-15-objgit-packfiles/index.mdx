...
<img
  ...
  alt='Two monospace panels on a dark background. The first, labelled "what a .idx entry holds", lists hash, crc32 and offset. The second, labelled "what a ranged GET needs", lists a first byte of 0x1f3a4 in green and a last byte of question marks in red, above the line Range: bytes=127908-???????'
/>
