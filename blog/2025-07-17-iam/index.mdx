...
import heroImage from "./one-must-imagine-sisyphus-happy.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="One must imagine Sisyphus happy - IAM illustration"
/>
...
<video controls width="100%">
  ...
  />
  Download the{" "}
  <a href="/blog/img/blog/iam-policy-builder/iam-editor-demo.mp4">MP4</a>{" "}
  version.
</video>
...
<video controls width="100%">
  ...
  />
  Download the{" "}
  <a href="/blog/img/blog/iam-policy-builder/training-job-demo.mp4">MP4</a>{" "}
  version.
</video>
