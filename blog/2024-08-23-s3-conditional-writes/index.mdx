...
import heroImage from "./twin-formula-1-race-car-drivers-navigating-a-sharp-turn-on-a-track-that-weaves-through-the-bustling--58786778.jpeg";

<img
  src={heroImage}
  className="hero-image"
  alt="Twin Formula 1 race car drivers navigating a sharp turn"
/>
