...
description: >
  Introducing the Tigris integration for Astro, and how to add your NoSQL data
  to your static or server rendered websites.
keywords: [jamstack, nosql, astro, database]
authors: [michael]
