...
description: >
  MongoDB compatibility has been added to the Tigris open source developer data platform 
  and is now available on Tigris Cloud, making Tigris a true alternative to MongoDB Atlas
...
MongoDB compatibility has been added to the Tigris open source developer data platform
and is now also available on Tigris Cloud.
...
value of `DB_NAME` with the name of the project you created in Tigris Cloud.
...
Tigris is an open source alternative to MongoDB Atlas. We've released the MongoDB
...
- **Global secondary indexes:** Tigris offers transactionally consistent global
  secondary indexes allowing quick lookups by any field.
- **Full-text search:** Tigris integrates a database, search engine, and
...
benefit from the full value of a data developer platform and get Search and other
products we launch through a unified API.
