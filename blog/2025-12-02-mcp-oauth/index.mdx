...
import McpMentalModel from "./diagrams/McpMentalModel";
import ClassicWebAppModel from "./diagrams/ClassicWebAppModel";
import WebAppOauth from "./diagrams/WebAppOauth";
import McpOauthChain from "./diagrams/McpOauthChain";
import ClientRegistration from "./diagrams/ClientRegistration";
import AuthorizeKickoff from "./diagrams/AuthorizeKickoff";
import Auth0Handshake from "./diagrams/Auth0Handshake";
import SecondInteraction from "./diagrams/SecondInteraction";
import TokenExchange from "./diagrams/TokenExchange";
...
the Tigris MCP server in the first place... and
[we’re over 99.99% available anyway](https://www.tigrisdata.com/blog/availability-metrics-public/)).
...
<InlineCta
  title="Storage usable from the CLI, Web, API, and Agents"
  subtitle="Store your files everywhere and use them from anywhere, even if you're using an AI agent."
  button="Sounds good to me!"
/>
