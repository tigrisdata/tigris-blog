...
In the early days of computing and network
...
The next step was to use password hashing to address the
...
The concept of adding salt to password hashes was introduced
...
SRP is an advanced authentication protocol
