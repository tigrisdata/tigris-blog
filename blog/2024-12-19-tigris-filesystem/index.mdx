...
set recording bot for an online radio station off of that single point of
failure. I've been involved with this station for over a decade and I've been
running their recording bot since the transition from IRC to Discord. I've
accumulated over 675 GB of DJ sets, including ones that were thought to be lost
media.

Each of these files is anywhere from 150 to 500 MB (with a few outliers). They
are MP3 audio files at about 320 KiB/sec and the sets usually rang from half an
hour to two hours.
...
older sets. I want to preserve these files and not just dump them in an
[Archive bucket](https://www.tigrisdata.com/docs/objects/tiers/) or something
that would make it hard/slow to access them. I want these to be easily
