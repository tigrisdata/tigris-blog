...
import heroImage from "./kubernetes-iris.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="An extreme close-up of a tiger with blue and orange fur. The Kubernetes logo replaces its iris."
/>

<center>
  <small>
    <em>
      An extreme close-up of a tiger with blue and orange fur. The Kubernetes
      logo replaces its iris.
    </em>
  </small>
</center>
