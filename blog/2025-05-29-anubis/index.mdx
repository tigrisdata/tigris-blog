...
![A gorgeous sunset taken out of the side of an airplane](./sunset.webp)
...
This data contains nested key-value pairs in two basic shapes:
...
query small data– and ultimately make the internet a better place by stopping
bots.
