...
import heroImage from "./anubis-tigris-motherduck.webp";
...
When the honeypot dataset outgrows a laptop and you want shared, snapshotted
analytics across machines, the natural next step is a DuckLake lakehouse on
Tigris — see
