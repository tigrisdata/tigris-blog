...
To demonstrate Tigris Search, we've created a demo application with
[Resend](https://resend.com) - an API platform that enables developers to build,
test, and deliver transactional email at scale - that simulates a series of
onboarding emails to be sent during the onboarding journey.
