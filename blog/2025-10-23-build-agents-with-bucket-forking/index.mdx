...
LangChain’s (Harrison Chase)[https://x.com/hwchase17] describes (four components
that make an agent)[https://www.youtube.com/watch?v=pBBe1pk8hf4]: planning, tool
use, memory, and reflection.
...
If you use a coding agent like Cursor, there are hundreds of (MCP
servers)[https://cursor.directory/mcp] you can use to access infrastructure
...
As (Simon Willison)[https://x.com/simonw] puts it, (vibe engineering)[https://simonwillison.net/2025/Oct/7/vibe-engineering/] is working with AI systems as
