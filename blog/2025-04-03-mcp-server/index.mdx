...
import heroImage from "./tiger-tools.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="A robotic blue tiger using tools to work on an engine."
/>
...
[access keys](https://console.storage.dev/createaccesskey) and then install our
MCP server:
