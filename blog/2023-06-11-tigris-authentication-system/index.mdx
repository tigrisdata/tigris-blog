...
![illustration_authentication_authorization_in_computer_security](authnz.webp)
...
![Double encryption of access key](double-encryption-of-key.webp)
...
![Session token based authentication](session-token-auth.webp)
...
![Authorization](authorization.webp)
