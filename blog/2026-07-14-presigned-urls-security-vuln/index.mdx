---
slug: presigned-urls-security-vuln
...
<img
  ...
  alt="A cat-eared, tiger-striped character sits at a desk overlooking the Golden Gate Bridge on one side and a floating crystal city on the other, working at a laptop and monitor showing a media/data sorting diagram."
/>
...
<InlineCta
  title="Want to hand out links that expire themselves?"
  subtitle="Tigris supports presigned URLs out of the box with the same SigV4 dance you already know, on globally distributed, S3-compatible object storage."
  button="Read the docs"
  link="https://www.tigrisdata.com/docs/objects/presigned/"
/>
