    ...
    >
      ...
      >
        ...
        <div>
          ...
          <span key={11}>{"   "}</span>
          <span key={12} style={{ color: "#475569" }}>
            {"│"}
          </span>
        </div>
        <div>
          ...
          <span key={11} style={{ color: "#f87171" }}>
            {" scheduler 1 "}
          </span>
          <span key={12} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={13} style={{ color: "#60a5fa" }}>
            {"──"}
          </span>
          <span key={14} style={{ color: "#475569" }}>
            {"┬"}
          </span>
          <span key={15} style={{ color: "#60a5fa" }}>
            {"───▶"}
          </span>
          <span key={16} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={17}>{" worker 1 "}</span>
          <span key={18} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={19}>{"   "}</span>
          <span key={20} style={{ color: "#475569" }}>
            {"│"}
          </span>
        </div>
        <div>
        ...
        <div>
          ...
          <span key={9} style={{ color: "#60a5fa" }}>
            {"───▶"}
          </span>
          <span key={10} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={11}>{" worker 2 "}</span>
          <span key={12} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={13}>{"   "}</span>
        ...
        <div>
          ...
          <span key={3}>{" transaction layer      "}</span>
          <span key={4} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={5}>{"             "}</span>
        ...
        <div>
          ...
          <span key={3}>{" query processing       "}</span>
          <span key={4} style={{ color: "#475569" }}>
            {"│"}
          </span>
          <span key={5}>{"             "}</span>
        ...
        <div>
          ...
          <span key={11} style={{ color: "#64748b" }}>
            {" worker 6 "}
          </span>
          <span key={12} style={{ color: "#475569" }}>
            {"│"}
