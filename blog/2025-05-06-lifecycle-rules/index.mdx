...
import heroImage from "./objects-transitioned.jpg";

<img
  src={heroImage}
  className="hero-image"
  alt="Ty happily transitioning objects between storage tiers"
/>
...
[pay per gigabyte restored](https://www.tigrisdata.com/pricing/#pricing-table),
