...
Here's what the logical Pixeltable table looks like once a few rows have been
inserted, with a primary key, metadata, and a computed embedding column:
...
Just Works™ with it -- point it at `t3.storage.dev` and the data is accessible
