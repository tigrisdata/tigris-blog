...
:::note In this post I’m calling these models “image models”, but they are
actually complex multi-modal models that are really good at image generation and
editing. :::
...
At Tigris we love multi-modal and image models, not just because our blog covers
are generated, but because some of our biggest customers train on and store
images. They also have become an essential part of how we think about content
and art. From thumbnails to storyboards, there is an increasing number of
use-cases where image models have become indispensable.
...
which of these models should you use? That’s why we published image-models.dev,
an app for you to compare image models’ generation and editing capabilities. For
now, we’ve picked the following models: gpt-image-1,
gemini-2.5-flash-image-preview and flux-kontext-pro. Let us know if there are
other models you want to see us add.

<video controls width="100%">
  <source src="/blog/img/blog/flux-vs-nano-banana/demo.mp4" type="video/mp4" />
  Download the <a href="/blog/img/blog/flux-vs-nano-banana/demo.mp4">
    MP4
  </a> version.
</video>
...
| ------------------------------------------------------------------ | ------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| ![](/blog/img/blog/flux-vs-nano-banana/gpt-image-1-generation.png) | ![](/blog/img/blog/flux-vs-nano-banana/nano-banana-generation.png) | ![](/blog/img/blog/flux-vs-nano-banana/flux-kontext-pro-generation.png) |
...
![](/blog/img/blog/flux-vs-nano-banana/image-editing.png)
...
![](/blog/img/blog/flux-vs-nano-banana/original-image.png)

| gpt-image-1                                                | nano-banana                                                  | flux-kontext-pro                                                  |
| ---------------------------------------------------------- | ------------------------------------------------------------ | ----------------------------------------------------------------- |
| ![](/blog/img/blog/flux-vs-nano-banana/gpt-image-edit.png) | ![](/blog/img/blog/flux-vs-nano-banana/nano-banana-edit.png) | ![](/blog/img/blog/flux-vs-nano-banana/flux-kontext-pro-edit.png) |
