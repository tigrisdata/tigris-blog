...
If you’re new to wiring DuckDB up to Tigris in the first place, our
[DuckDB quickstart](https://www.tigrisdata.com/docs/quickstarts/duckdb/) walks
through creating the S3 secret and reading data from a bucket.
...
on big and small scales. For a follow-up that puts the snapshot mechanics to
work, see
