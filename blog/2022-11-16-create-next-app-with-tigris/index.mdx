...
![The create-tigirs-app terminal command displayed within a dialog within the Tigris web console](/img/screenshots/create-new-project-dialog-2.png)
...
![The Tigris database and collection created after running the Next.js application](/img/screenshots/tigris-web-console-collections.png)
