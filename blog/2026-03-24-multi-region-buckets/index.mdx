...
import MultiRegionEur from "./diagrams/MultiRegionEur";
import DualRegionPinned from "./diagrams/DualRegionPinned";
import SingleRegionSin from "./diagrams/SingleRegionSin";
