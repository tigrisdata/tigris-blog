...
At Tigris, we realize that this data inertia is the main reason why you wouldn’t
want to use Tigris for your object storage needs. So we implemented
...
|                         **Risk of downtime** |      Low – Tigris is globally distributed so even when a datacentre is lost you seamlessly get re-routed to another one.      | Medium – one phase of your data migration will require you to shut down services to copy over data, which is risky and expensive. |
...
|                 Globally distribute your object storage |     ✅     | Provider-specific if offered |
