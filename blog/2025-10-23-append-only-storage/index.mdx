...
import heroImage from "./append-only.webp";

<img
  src={heroImage}
  alt="Append-Only Object Storage: The Foundation Behind Cheap Bucket Forking"
...
<div style={{ marginLeft: "2rem" }}>
  ...
  <em>
    Tigris' design is influenced by my time at Uber. My co-founders and I built
    Uber's global storage platform, scaling to hundreds of billions of requests
    daily. We migrated Uber's core trips data from a single Postgres instance to
    <a href="https://www.uber.com/blog/schemaless-part-one-mysql-datastore/">Schemaless</a>, which has a similar append-only data model.
  </em>
</div>

<img
  src={require("./log-db.webp").default}
...
Immutable snapshots form a verifiable audit trail. Forks can restore state
instantly after errors.
