...
<QuickSummary
  items={[
    {
      title: "Security data lakehouse.",
      description:
        "LogSeam provides AI-driven anomaly detections built to reduce time-to-response to critical incidents.",
    },
    {
      title: "Massive scale.",
      description:
        "Searches over 500 million logs per second, delivering over 1.5 TB/s of throughput while cutting costs by 40–80%.",
    },
    {
      title: "Efficient storage.",
      description:
        "JSON logs are reformatted into Parquet files, reducing storage by up to 100× and optimizing sequential scanning.",
    },
    {
      title: "Global distribution with Tigris.",
      description:
        "Data is placed close to query origins to minimize latency and increase throughput, all while cutting costs.",
    },
  ]}
/>
