...
import heroImage from "./prone-tiger-vibe.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="A prone cartoon tiger vibing on a pier with coffee"
/>
...
- A Tigris bucket
- A Tigris [authentication keypair](https://console.storage.dev/createaccesskey)
