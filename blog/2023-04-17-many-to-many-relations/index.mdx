...
title:
  Modeling NoSQL many-to-many relationships and quering with full text search -
...
This is part 3 of the **Tigris Data Modeling Series**. In part one of the
series, we covered
...
many-to-many relations. We model NoSQL many-to-many relations in two ways:

1. As embeded documents
2. As related documents and will use full-text search to perform advanced
...
## Embeded Many-to-Many NoSQL data modeling
...
This completes the relationship modeling series. This series covered the three
main ways to model relationships. How to model each one in a few different ways
to fit your needs and most importantly how to do that safely with transactions.
