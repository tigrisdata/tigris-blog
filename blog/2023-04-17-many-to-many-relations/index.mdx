...
title: Modeling NoSQL many-to-many relationships and quering with full-text search
description: >
  This blog post shows how to model many-to-many relations using embeded
  documents and referencing another collection.  It shows how to use Tigris's
  transactions to make updates across collections consistent. And recommends
  when to use either pattern. It also shows how to use full-text Search for
  advanced queries.
keywords:
  [
    nosql,
...
tags: [nosql data modeling, nosql database design, full-text search]
---
...
[NoSQL Data Modeling Series](/blog/tags/nosql-data-modeling/). In part one of
the series, we covered
...
2. [Many-to-many using a joining collection NoSQL data modeling](/blog/nosql-modeling-many-to-many-relations-with-search/#joining)
...
![Modeling NoSQL many-to-many image](modeling-many-to-many.png)
...
## Many-to-many using a joining collection NoSQL data modeling {#joining}
...
This completes the
[NoSQL data modeling series](/blog/tags/nosql-data-modeling/). This series
covered the three main ways to model relationships. How to model each one in a
few different ways to fit your needs and most importantly how to do that safely
with transactions.
