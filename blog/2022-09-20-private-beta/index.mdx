...
<a href={tigrisConfig.signupUrl}>
  <img src={require('./blog-header-beta.jpg').default} alt="Complexity to Simplicity with Tigris" />
</a>
...
🚀 <a href={tigrisConfig.signupUrl}>Signup for the Tigris beta and get early access!</a>
