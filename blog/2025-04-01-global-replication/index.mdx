...
>
  <video
    ...
    onLoad={() => {
const v = document.getElementById("attract-video");
setTimeout(async () => {
  if (v.paused) {
    await v.play();
  }
...
![](./tiger-globe.webp)
  ...
  <script type="text/javascript" src="data:text/javascript;base64,Y29uc3QgdiA9IGRvY3VtZW50LmdldEVsZW1lbnRCeUlkKCJhdHRyYWN0LXZpZGVvIik7DQpzZXRUaW1lb3V0KGFzeW5jICgpID0-IHsNCiAgaWYgKHYucGF1c2VkKSB7DQogICAgYXdhaXQgdi5wbGF5KCk7DQogIH0NCn0sIDI1MCk7" />
</div>
