...
lands in the bucket. An agent can search "kitchen with granite countertops"
and get back the exact timestamp in the exact video — across thousands of hours
of footage. No polling delay, no manual tagging.
...
<InlineCta
  title="Make your media searchable in minutes"
  subtitle={
    "Connect your Tigris bucket to Mixpeek and start querying video, audio, images, and PDFs through a single API. Free to get started."
  }
  button="Try Mixpeek"
  link="https://docs.mixpeek.com/docs/integrations/object-storage/tigris"
/>
keywords:
  - Tigris
  - Mixpeek
