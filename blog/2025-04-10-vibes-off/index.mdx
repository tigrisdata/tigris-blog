...
I kinda don't like vibe coding because of this constant swapping you have to do
from writing code to reviewing code and back in quick succession. I find that it
really makes me break my flow because those are _significant_ mindset changes
for me. If you're used to it or not quite as neurodivergent as I am, it's
probably fine, but it's not for me.
