...
import heroImage from "./time-travel.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="Time travel illustration for DuckLake time travel"
/>
...
[install DuckDB](https://duckdb.org/docs/installation/) and follow the
[Tigris DuckDB quickstart](https://www.tigrisdata.com/docs/quickstarts/duckdb/)
to set up your S3 secret, then load the Ducklake extension:
