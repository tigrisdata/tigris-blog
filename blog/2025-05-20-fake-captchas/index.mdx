...
import heroImage from "./tiger-in-soc.webp";
import ScanDecisionFlow from "./diagrams/ScanDecisionFlow";
import ScanVerdictFlow from "./diagrams/ScanVerdictFlow";

<img
  src={heroImage}
  className="hero-image"
  alt="Ty the tiger monitoring alerts in a security operations center"
/>
...
![A fake reCAPTCHA detected by Virus Total and removed from a Tigris bucket](./captcha-sample.webp)
...
![HTML containing an obfuscated Javascript function](./html-sample.webp)
