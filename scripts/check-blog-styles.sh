...
# This ensures consistent styling across all posts (hero images + content width)
...
if ((exit_code == 1)); then
  ...
  echo
  echo "You can copy styles.css from another recent blog post (e.g., blog/2026-01-06-tigris-rag-lab/styles.css)."
fi
