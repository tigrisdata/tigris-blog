...
import heroImage from "./beam.webp";

<img
  src={heroImage}
  className="hero-image"
  alt="Tigris tiger watching a beam from a ground satellite."
/>
  ...
  items={[
    {
      ...
      description:
        "Beam provides sub-10s cold starts, 50ms warm starts, and limitless horizontal scale across clouds.",
    },
    {
      title: "Multi-cloud flexibility.",
      description:
        "Decoupled compute from storage with Tigris, eliminating cloud lock-in and months of custom replication work.",
    },
    {
      title: "Object storage native.",
      description:
        "Tigris dynamically distributes data based on access patterns, keeping models and training data close to GPUs.",
    },
    {
      title: "Open source platform.",
      description:
        "Beam open sourced beta9, enabling self-hosted portable workloads on any cloud, on-prem, or hybrid architecture.",
    },
  ]}
/>
